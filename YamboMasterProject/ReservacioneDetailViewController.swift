...
//extension ReservacioneDetailViewController: JTAppleCalendarViewDelegate, JTAppleCalendarViewDataSource {
//
...
//        let cell = calendar.dequeueReusableJTAppleCell(withReuseIdentifier: "ReservacioneCalendarCell", for: indexPath) as! ReservacioneCalendarCell
//
